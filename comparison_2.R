...
# these are the sample IDs for  COMPARISON 2
listOfIDscomparison2 <- c('RhCMV_1',
                          'RhCMV_2',
                          'RhCMV_3',
                          'RhCMV_4',
                          'RhCMV_5',
...
#creating a factor with the samples, Rhcmv versus UV comparison 
# rhcmv = 1 and UV =2 
...
sampleInfo <- read.table("design_comparison2.csv", header=TRUE, sep=",", row.names=1)
View(sampleInfo)
...
hist(pseudoCounts[,"RhCMV_1"], main="RhCMV_1", xlab="PseudoCounts")
hist(pseudoCounts[,"RhCMV_2"], main="RhCMV_2", xlab="PseudoCounts")
hist(pseudoCounts[,"RhCMV_3"], main="RhCMV_3", xlab="PseudoCounts")
hist(pseudoCounts[,"RhCMV_4"], main="RhCMV_4", xlab="PseudoCounts")
hist(pseudoCounts[,"RhCMV_5"], main="RhCMV_5", xlab="PseudoCounts")
hist(pseudoCounts[,"RhCMV_6"], main="RhCMV_6", xlab="PseudoCounts")
...
hist(pseudoCounts[,"UV_4"], main="UV_4", xlab="PseudoCounts")
...
plotMDS(pseudoCounts, xlim=c(-7,7), ylim=c(-3, 1.5) ,
...
#this is what we expact, vaccinated cluster with vaccinated 
...
plotMDS(pseudoCounts, xlim=c(-7,7), ylim=c(-3, 1.5) , main='Before Normalization',
        ...
        col=c(rep("red",1),rep("red",1),rep("red",1),rep("red",1), rep("red",1),rep("red",1),
              rep("blue",2),rep("blue",2),rep("blue",2),rep("blue",2), rep("blue",2),rep("blue",2) ))
...
write.csv(sigDownReg, file="sigDownReg_comparison_2final.csv")
write.csv(sigUpReg, file="sigUpReg_comparison_2final.csv")
